...
fun Greeting(context: Context) {
    ...
    Column(
        ...
        Box(
            ...
            Text(text = "Стоимость ${name.value}: ${state.value} RUB")
        }
        Box(
            modifier = Modifier
                .fillMaxHeight(0.3f)
            ...
            TextField( value = name.value,onValueChange = {newText -> name.value = newText}, singleLine = true)
        }
        Box(
            modifier = Modifier
                .fillMaxSize(),
...
fun getPriceData(name: String, context: Context, mState: MutableState<String>) {
    ...
    val stringRequest = StringRequest(
        ...
        { response ->
            ...
            mState.value = temp.getString("rub")
            Log.d("MyLog", "Response: ${temp.getString("rub")}")
        },
        {
...
fun getImgData(name: String, context: Context, mState: MutableState<String>) {
    ...
    val stringRequest = StringRequest(
        ...
        { response ->
            ...
            mState.value = temp.getString("large")
            Log.d("MyLog", "Response: ${temp.getString("large")}")
        },
        {
            Log.d("MyLog", "Volley error: $it")
        }
